...
description: Password reset flow for Next.js 16 with Better Auth. Configure password reset tokens, email callbacks, and server actions for forgot/reset password.
---
...
|--------|---------|-------|
| `"30m"` | 30 minutes | Short-lived tokens for security |
| `"1h"` | 1 hour | Default recommendation |
| `"2h"` | 2 hours | Longer window for slow email delivery |
| `"1d"` | 24 hours | Not recommended for security |
