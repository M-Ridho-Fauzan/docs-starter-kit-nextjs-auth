...
- [Middleware](../api/middleware.md) — Route protection
- [Server Utilities](../api/server-utils.md) — All server utilities
- [Database Schema](../database/schema-reference.md) — User model with role field
