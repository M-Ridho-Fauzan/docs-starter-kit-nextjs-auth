...
description: Struktur file dan folder dari Next.js 16 Auth Starter Kit. Pahami bagaimana proyek diorganisir untuk dengan cepat menemukan dan memodifikasi kode.
---
...
- [Konfigurasi](./configuration) — Referensi file konfigurasi
- [Alat CLI](../reference/cli-tools) — Wizard setup dan generator
