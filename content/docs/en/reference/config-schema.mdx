...
- [Configuration](../get-started/configuration) — Practical config examples
- [TypeScript Types](../reference/types) — Type exports
- [CLI Tools](./cli-tools) — Setup wizard uses this schema
