...
- [Server Utilities](../api/server-utils) — `getServerSession`, `hasRole`
- [Middleware](../api/middleware) — Route-level protection
- [Roles](../auth-features/roles) — Role system reference
